...
| Link configuration, control or recover AGS, regenerate colours, or use `tp` | [Command Reference](docs/Commands.md) |
| Review implemented milestones and remaining refinements | [Roadmap](docs/Roadmap.md) |
